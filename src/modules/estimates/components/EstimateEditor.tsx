        ...
        <div className="divide-y divide-zinc-100">
          {products.products.map((product) => (
            <label className="grid cursor-pointer gap-3 py-3 sm:grid-cols-[auto_3rem_minmax(0,1fr)_7rem] sm:items-center" key={product.id}>
              ...
              <span className="relative flex size-12 items-center justify-center overflow-hidden bg-zinc-100"><ProductThumbnail alt={product.name} className="object-contain p-1" sizes="48px" src={product.imageUrl} variant="xs" /></span>
