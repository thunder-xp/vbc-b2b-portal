...
describe("estimate daily-workflow acceptance", () => {
  ...
  it.todo("provides visible keyboard hints for save, product picker, preview, and version creation");
  it.todo("keeps the 100-line editor usable without per-cell requests");
});
