...
describe("guided Estimate next-action architecture", () => {
  ...
  it("renders the service projection without browser data access or parallel lifecycle interpretation", () => {
    ...
    expect(page).toContain("workflowPanel={<EstimateWorkflowPanel");
  });
