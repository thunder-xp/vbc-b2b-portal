...
export type GeneratorResolutionKind = "unresolved" | "catalog" | "service" | "own_nomenclature" | "shared_nomenclature";
...
export function countGeneratorResolutions(requirements: readonly GeneratorRequirement[]) {
  return requirements.reduce((counts, requirement) => {
    ...
    else if (requirement.resolution === "service") counts.service += 1;
    ...
    return counts;
  }, { catalog: 0, service: 0, own: 0, shared: 0, unresolved: 0 });
}
