...
export interface RetailMarketplaceRepository {
  ...
  simulatePayment(input: { retailOrderId: string; reason: string; idempotencyKey: string }): Promise<RetailPaymentActivationResult>;
