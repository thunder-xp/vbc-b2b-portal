...
const claimedItemSchema = z.object({
  ...
  purpose: z.enum(["TRANSACTIONAL", "FINANCE", "SECURITY", "SUPPORT", "CUSTOMER_SERVICE", "MARKETING"]).optional(),
  ...
  sensitivity: z.enum(["PUBLIC", "PARTNER_PRIVATE", "CUSTOMER_PRIVATE", "FINANCIAL_PRIVATE", "SECURITY_SENSITIVE"]).optional(),
