...
const ITEM_COLUMNS = "id, list_id, product_id, quantity, position, note, source_type, source_reference_id, source_unit_price, source_currency_code, product_name_snapshot, product_image_url_snapshot, created_at, updated_at";
