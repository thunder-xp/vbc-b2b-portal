...
export function AddToPurchasingListButton({ productId }: { productId: string }) {
  ...
  return <><button className="inline-flex items-center gap-2 rounded-md border border-zinc-300 bg-white px-3 py-2 text-sm font-semibold text-zinc-800" onClick={() => setOpen(true)} type="button"><ListPlus className="size-4" />Добавить в список</button>
