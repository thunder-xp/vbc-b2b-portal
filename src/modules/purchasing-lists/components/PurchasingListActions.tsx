...
export function PurchasingListActions({ listId, name, revision, archived, canManage }: { listId: string; name: string; revision: number; archived: boolean; canManage: boolean }) {
