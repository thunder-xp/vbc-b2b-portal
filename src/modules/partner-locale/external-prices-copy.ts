...
const ru = {
    ...
    apply: "Применить", archive: "Архивировать", skip: "Пропустить", confirmMatch: "Подтвердить", rows: "Строки прайса", suggested: "Возможные товары", none: "Нет", refresh: "Обновить статус",
...
const ro: { [Key in keyof typeof ru]: string } = {
    ...
    apply: "Aplică", archive: "Arhivează", skip: "Omite", confirmMatch: "Confirmă", rows: "Rândurile listei", suggested: "Produse posibile", none: "Nu există", refresh: "Actualizează statutul",
