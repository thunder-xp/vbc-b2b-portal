...
const ru = {
    ...
    apply: "Применить", archive: "Архивировать", correctImport: "Исправить импорт", correctionReason: "Причина исправления", correctionReasonPlaceholder: "Укажите, что было классифицировано неверно", startCorrection: "Пересчитать предварительный просмотр", skip: "Пропустить", confirmMatch: "Подтвердить", rows: "Строки прайса", suggested: "Возможные товары", none: "Нет", refresh: "Обновить статус",
...
const ro: { [Key in keyof typeof ru]: string } = {
    ...
    apply: "Aplică", archive: "Arhivează", correctImport: "Corectează importul", correctionReason: "Motivul corectării", correctionReasonPlaceholder: "Indicați ce a fost clasificat incorect", startCorrection: "Recalculează previzualizarea", skip: "Omite", confirmMatch: "Confirmă", rows: "Rândurile listei", suggested: "Produse posibile", none: "Nu există", refresh: "Actualizează statutul",
