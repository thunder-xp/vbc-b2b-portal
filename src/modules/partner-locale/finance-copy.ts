...
export const getFinanceCopy = definePartnerCopy(
  {
    ...
    currentStatus: "Текущее финансовое состояние",
    noUrgentPayments: "Срочных платежей нет",
    paymentAttention: "Требуется внимание к оплате",
    dataFresh: "Данные актуальны",
    dataStale: "Данные устарели — напоминания приостановлены",
    overdue: "Просрочено",
    nearestPayment: "Ближайший платеж",
    openCalendar: "Открыть платежный календарь",
    paymentCalendar: "Платежный календарь",
    calendarDescription: "Текущие обязательства по данным 1С, по сроку оплаты.",
    overdueGroup: "Просрочено",
    todayGroup: "Сегодня",
    upcomingGroup: "Ближайшие",
    laterGroup: "Позже",
    remaining: "К оплате",
    paid: "Оплачено",
    planned: "По заказу",
    openStatus: "Ожидает оплаты",
    partialStatus: "Частично оплачено",
    dueDate: "Срок оплаты",
    order: "Заказ",
    openOrder: "Открыть заказ",
    daysOverdue: "Просрочено: {count} дн.",
    daysUntil: "До оплаты: {count} дн.",
    dueToday: "Сегодня срок оплаты",
    settledHistory: "История / Оплачено",
    settled: "Оплачено",
    noCurrentObligations: "Нет текущих обязательств к оплате.",
    unavailableRows: "Часть данных не показана до подтверждения сверки с 1С.",
  } as const,
  {
    title: "Finanțe",
    ...
    currentStatus: "Situația financiară curentă",
    noUrgentPayments: "Nu există plăți urgente",
    paymentAttention: "Plata necesită atenție",
    dataFresh: "Date actuale",
    dataStale: "Datele sunt învechite — notificările sunt suspendate",
    overdue: "Restant",
    nearestPayment: "Următoarea plată",
    openCalendar: "Deschide calendarul de plăți",
    paymentCalendar: "Calendar de plăți",
    calendarDescription: "Obligațiile curente conform datelor 1C, în ordinea termenului.",
    overdueGroup: "Restante",
    todayGroup: "Astăzi",
    upcomingGroup: "Următoarele",
    laterGroup: "Mai târziu",
    remaining: "De achitat",
    paid: "Achitat",
    planned: "Total comandă",
    openStatus: "În așteptarea plății",
    partialStatus: "Achitat parțial",
    dueDate: "Termen de plată",
    order: "Comanda",
    openOrder: "Deschide comanda",
    daysOverdue: "Restant de {count} zile",
    daysUntil: "Până la plată: {count} zile",
    dueToday: "Termenul de plată este astăzi",
    settledHistory: "Istoric / Achitate",
    settled: "Achitat",
    noCurrentObligations: "Nu există obligații curente de plată.",
    unavailableRows: "Unele date nu sunt afișate până la confirmarea reconcilierii cu 1C.",
  },
);
