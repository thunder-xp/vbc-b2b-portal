...
import type { AgentRewardState } from "../agent-commercial";
...
export const agentCabinetCopy = {
  ru: {
    ...
    rewardsTitle: "Вознаграждения", expected: "Начисляется", review: "На проверке", available: "Готово к выплате", paid: "Выплачено", monthlyStatement: "История начислений", noRewards: "Начислений пока нет.",
  ...
  ro: {
    ...
    rewardsTitle: "Recompense", expected: "Se calculează", review: "În verificare", available: "Pregătit pentru plată", paid: "Plătit", monthlyStatement: "Istoricul calculărilor", noRewards: "Nu există calculări.",
...
export const agentRewardStateCopy: Record<AgentCabinetLocale, Record<AgentRewardState, string>> = {
  ru: {
    FORECAST: "Начисляется", ELIGIBLE: "Готово к финансовой проверке", FINANCE_REVIEW: "Проверяется",
    APPROVED: "Одобрено", READY_FOR_PAYOUT: "Готово к выплате", PAID: "Выплачено",
    ADJUSTED: "Скорректировано", BLOCKED: "Заблокировано",
  },
  ro: {
    FORECAST: "Se calculează", ELIGIBLE: "Pregătit pentru verificarea financiară", FINANCE_REVIEW: "În verificare",
    APPROVED: "Aprobat", READY_FOR_PAYOUT: "Pregătit pentru plată", PAID: "Plătit",
    ADJUSTED: "Ajustat", BLOCKED: "Blocat",
  },
};

export const agentRewardBlockedReasonCopy: Record<AgentCabinetLocale, Record<string, string>> = {
  ru: {
    CLASSIFICATION_PENDING: "Состав продажи ещё классифицируется.",
    PAYMENT_RECONCILIATION: "Коммерческие документы и оплата проходят сверку.",
    REVIEW_REQUIRED: "Вознаграждение требует проверки Novotech.",
  },
  ro: {
    CLASSIFICATION_PENDING: "Componența vânzării este încă în curs de clasificare.",
    PAYMENT_RECONCILIATION: "Documentele comerciale și plata sunt în curs de reconciliere.",
    REVIEW_REQUIRED: "Recompensa necesită verificarea Novotech.",
  },
};
