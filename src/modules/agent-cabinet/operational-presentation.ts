...
export function attributionStatusTone(status: AgentClientView["status"] | null | undefined): CabinetStatusTone { return status === "ACTIVE" ? "success" : status ? "neutral" : "pending"; }
