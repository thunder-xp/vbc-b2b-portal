export type BusinessPhoneEnrollmentPublicState =
  ...
  | { ok: false; error: "INVALID_PHONE" | "INVALID_CODE" | "PHONE_CONFLICT" | "PHONE_TARGET_MISMATCH" | "AUTH_REQUIRED" | "NOT_ELIGIBLE" | "EXPIRED" | "PROVIDER_TEMPORARY" | "RATE_LIMITED" | "UNAVAILABLE"; retryAfterSeconds?: number };
