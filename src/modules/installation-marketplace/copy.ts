...
export const marketplaceCopy = {
  ru: {
    ...
    recommended: "Рекомендуем", newPartner: "Новый проверенный партнёр", verifiedInstallations: "подтверждённых монтажей",
    responseFast: "Обычно отвечает быстро", responseSameDay: "Обычно отвечает в течение дня", responseLonger: "Ответ может занять больше дня",
  ...
  ro: {
    ...
    recommended: "Recomandat", newPartner: "Partener nou verificat", verifiedInstallations: "instalări confirmate",
    responseFast: "Răspunde de obicei rapid", responseSameDay: "Răspunde de obicei în aceeași zi", responseLonger: "Răspunsul poate dura mai mult de o zi",
