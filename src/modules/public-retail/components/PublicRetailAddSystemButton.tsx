...
export function PublicRetailAddSystemButton({ locale, items, installationIntent, installationPricing, calculatorInput, workScope }: { locale: PublicRetailLocale; items: Array<{ publicProductId: string; quantity: number; commercialGroup: "equipment" | "materials"; unitCode: "piece" | "meter" | "service" }>; installationIntent: Record<string, boolean> | null; installationPricing: Record<string, unknown> | null; calculatorInput: Record<string, unknown>; workScope: Array<{ kind: string; quantity: number; unitCode: "piece" | "meter" | "service" }> }) {
