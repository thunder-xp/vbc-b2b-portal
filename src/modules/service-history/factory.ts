...
import { OneCServiceHistoryProvider } from "./one-c-service-history.provider";
...
export function createServiceHistorySyncService() {
  ...
  return new ServiceHistorySyncService(new OneCServiceHistoryProvider(client), new ServiceHistoryRepository());
}
