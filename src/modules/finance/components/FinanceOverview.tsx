  ...
  if (overview.contracts.length === 0) {
    return (
      <section className="border-t border-zinc-200 py-12 text-center">
        ...
        <h2 className="mt-3 text-lg font-semibold text-zinc-900">Нет ненулевых балансов</h2>
        <p className="mt-1 text-sm text-zinc-600">По активным договорам задолженность и аванс отсутствуют.</p>
      </section>
    );
  }
