...
function approvalFailureMessage(code?: string, currentWizardStep?: number | null): string {
  ...
  const message = {
    ...
    counterparty_no_longer_active: "Контрагент больше не активен в 1С. Выберите другую запись.",
    COUNTERPARTY_NO_LONGER_ACTIVE: "Контрагент больше не активен в 1С. Выберите другую запись.",
    counterparty_identity_conflict: "Обнаружено несколько записей с одинаковыми реквизитами. Требуется проверка.",
    COUNTERPARTY_IDENTITY_CONFLICT: "Обнаружено несколько записей с одинаковыми реквизитами. Требуется проверка.",
    counterparty_snapshot_stale: "Обнаружено несколько записей с одинаковыми реквизитами. Требуется проверка.",
    ...
    invalid_price_profile: "Выбранный тип цены из 1С больше недоступен. Вернитесь к коммерческим условиям и выберите актуальный тип цены.",
    ONBOARDING_PARTNER_STATUS_INVALID: "Выбранный тип цены из 1С больше недоступен. Вернитесь к коммерческим условиям и выберите актуальный тип цены.",
    ONBOARDING_PARTNER_STATUS_SELECTION_REQUIRED: "Доступно несколько типов цены из 1С. Вернитесь к коммерческим условиям и выберите один из них.",
    ONBOARDING_PRICE_TYPE_REQUIRED: "Для партнёрского доступа нужен актуальный тип цены из 1С. Вернитесь к коммерческим условиям или выберите профиль только с розничными ценами.",
