...
export function ProductList({ capabilities, catalogState, commercialViews = {}, companyId, contextBadge, favoriteProductIds = [], locale = "ru", products, userId }: {
  ...
  return <div className="divide-y divide-zinc-200 overflow-hidden rounded-md border border-zinc-200 bg-white">
    {products.map((product, index) => {
      ...
      return <article className="grid min-w-0 grid-cols-[64px_minmax(0,1fr)] gap-3 p-3 xl:items-center xl:max-[1439px]:grid-cols-[72px_minmax(180px,1fr)_minmax(150px,0.72fr)_minmax(130px,0.55fr)] min-[1440px]:grid-cols-[64px_minmax(6rem,1fr)_minmax(5.5rem,0.72fr)_minmax(5.5rem,0.55fr)_minmax(22.75rem,auto)]" key={product.id}>
        ...
        <div className="col-span-2 flex min-h-11 flex-wrap items-start justify-end gap-2 xl:max-[1439px]:col-span-4 min-[1440px]:col-span-1 min-[1440px]:min-h-[5.25rem] min-[1440px]:flex-nowrap min-[1440px]:pt-[0.5625rem]" data-testid="catalog-list-actions">
