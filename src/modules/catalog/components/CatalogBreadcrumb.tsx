...
export function CatalogBreadcrumb({ categories, locale = "ru", selectedId }: { categories: CatalogCategoryDto[]; locale?: PartnerLocale; selectedId?: string }) {
