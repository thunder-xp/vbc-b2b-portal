...
function getAvailabilityTone(status: StockView extends infer T ? T extends { status: infer S } ? S | undefined : undefined : undefined) {
  switch (status) {
    ...
    case "low_stock":
      return { container: "bg-amber-50/60", indicator: "bg-amber-600", text: "text-amber-950" };
    case "expected":
      return { container: "bg-sky-50/60", indicator: "bg-sky-600", text: "text-sky-950" };
    case "out_of_stock":
      return { container: "bg-rose-50/60", indicator: "bg-rose-600", text: "text-rose-950" };
    default:
      return { container: "bg-zinc-50", indicator: "bg-zinc-500", text: "text-zinc-700" };
  }
}
