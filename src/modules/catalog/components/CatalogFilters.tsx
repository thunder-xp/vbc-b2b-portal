...
function persistentParams(props: Props) { return { brand: props.brandId, category: props.categoryId, categories: categoryParam(props.categoryIds), categorySet: props.categorySet, collection: props.collection, label: props.merchandisingLabel, period: (props.merchandisingLabel === "TOP" || props.merchandisingLabel === "NEW") && props.period && props.period !== 365 ? String(props.period) : undefined, search: props.search, sort: props.sort && props.sort !== "default" ? props.sort : undefined, view: props.explicitAll ? "all" : undefined }; }
