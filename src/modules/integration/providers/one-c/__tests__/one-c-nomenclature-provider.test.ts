...
function row(reference: string, parent: string | null, isFolder: boolean, name: string, overrides: Record<string, unknown> = {}) { return { Ref_Key: reference, Parent_Key: parent, IsFolder: isFolder, DeletionMark: false, DataVersion: "v1", ДатаИзменения: "2026-07-12T00:00:00", Code: "CODE", Артикул: "", Description: name, НаименованиеПолное: name, PS_ВидНоменклатурыБУ: isFolder ? null : "Товар", ЭтоНабор: false, ...overrides }; }
