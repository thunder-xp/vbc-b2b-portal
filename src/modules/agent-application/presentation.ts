...
export const commercialAgentApplicationCopy = {
  ru: {
    ...
    successText: "Статус заявки будет доступен после входа.",
  ...
  ro: {
    ...
    successText: "Statutul cererii va fi disponibil după autentificare.",
...
export function applicationStatusCopy(status: CommercialAgentApplicationStatus, locale: PublicLocale) {
  const copy = locale === "ru" ? {
    ...
    SUBMITTED: ["Заявка отправлена на проверку", "Статус заявки будет доступен после входа."],
    ...
    SUBMITTED: ["Cererea a fost trimisă spre verificare", "Statutul cererii va fi disponibil după autentificare."],
