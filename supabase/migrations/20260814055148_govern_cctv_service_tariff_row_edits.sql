-- Govern one inline CCTV service edit across the shared tariff and object binding.
...
comment on function public.admin_save_cctv_service_configuration(
  text,text,numeric,boolean,boolean,smallint,text,integer,uuid,integer,text
) is 'Atomically versions and publishes one shared CCTV tariff line and updates one object binding; B2B and B2C retain one tariff source.';
