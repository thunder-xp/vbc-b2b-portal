...
import { LocalizationBulkTransfer } from "@/src/modules/localization/LocalizationBulkTransfer";
...
export default async function AdminLocalizationPage({ searchParams }: {
  ...
  const cards = [
    ...
    ["Черновики", page.summary.machineDraftCategories + page.summary.machineDraftProducts],
