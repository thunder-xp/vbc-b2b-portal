...
export default async function CustomersPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return <div className="space-y-5">
    <header className="border-b border-zinc-200 pb-5"><p className="text-xs font-semibold uppercase text-emerald-700">Сметы и КП</p><h1 className="mt-1 text-2xl font-semibold">Мои заказчики</h1><p className="mt-1 text-sm text-zinc-500">Заказчики, используемые в сметах активной компании.</p></header>
