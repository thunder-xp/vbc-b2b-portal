  ...
  return <PublicRetailShell languagePath="/" locale={locale}>
    ...
    <main>
      <section className="relative isolate min-h-[520px] overflow-hidden sm:min-h-[570px] lg:min-h-[600px]">
        <Image alt={ru ? "Профессиональная установка системы видеонаблюдения" : "Instalarea profesională a unui sistem de supraveghere video"} className="object-cover object-[68%_center]" fill preload sizes="100vw" src="/retail/security-installation-hero.webp" />
