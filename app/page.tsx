        ...
        <div className="relative mx-auto flex min-h-[560px] max-w-[1440px] items-center px-4 py-14 sm:min-h-[600px] sm:px-6 lg:min-h-[620px] lg:px-8">
          <div className="max-w-2xl text-white">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link className="inline-flex min-h-12 items-center justify-center gap-2 rounded-sm bg-[#236FD0] px-6 text-sm font-semibold text-white transition-colors hover:bg-[#1F60B8] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white" href={`/calculator/cctv?lang=${locale}`}>{ru ? "Рассчитать систему" : "Calculează sistemul"}<ArrowRight aria-hidden="true" className="size-4" /></Link>
